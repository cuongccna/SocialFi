...
CREATE TABLE users (
    ...
    -- Location (PostGIS Geography for geo-queries)
...
-- Spatial index for geo-queries (ST_DWithin)
CREATE INDEX idx_users_location ON users USING GIST (location);
CREATE INDEX idx_users_telegram_id ON users (telegram_id);
CREATE INDEX idx_users_wallet_address ON users (wallet_address);
CREATE INDEX idx_users_market_price ON users (market_price DESC);
...
CREATE TABLE relationships (
    ...
    CONSTRAINT unique_relationship UNIQUE (LEAST(user_a, user_b), GREATEST(user_a, user_b)),
...
CREATE INDEX idx_prediction_markets_relationship ON prediction_markets (relationship_id);
CREATE INDEX idx_prediction_markets_status ON prediction_markets (status);
CREATE INDEX idx_prediction_markets_expiry ON prediction_markets (expiry_date);
...
CREATE INDEX idx_bets_position ON bets (position);
...
CREATE INDEX idx_disputes_relationship ON disputes (relationship_id);
...
CREATE INDEX idx_jury_votes_side ON jury_votes (vote_side);
...
-- ============================================
-- Sample PostGIS Query (for reference)
-- Find users within X km radius excluding already swiped
-- ============================================
/*
SELECT u.*
FROM users u
